...
import java.util.*;
/**
 * 功能描述:得到Spring Security 属性文件中的配置值
 * 
 * @date 2018-4-24 下午13:12:08
 */
public class SecurityConfig {
	...
	private static void loadProperties(){
		...
		try {
			...
			if(!configures.containsKey("loginPage") || "".equals(configures.get("loginPage").trim())){
				configures.put("loginPage", "/view/loginout/login.do");
			}
		} catch (IOException e) {
			e.printStackTrace();
		}
