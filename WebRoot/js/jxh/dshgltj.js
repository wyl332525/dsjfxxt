...
function getData() {
	...
	var args1 = {
			//sqlKey : "com.kmzc.dao.dsj.jxhnew.dsjcffhgltj",
			sqlKey : "com.kmzc.dao.dsj.jxhnew.jcffhgl",
			starttime : startdate,
			endtime : enddate
		}
...
//	window.top.$("#checkQualifieCityWinIframe").attr("src", rootPath + "/common/jxh/dsgelCity.yt?City="+City);
//	checkQualifieCityWin.window('open');
	//parent.popWindow.init(1600, 650, rootPath + "/view/mainpage/dsgelCity.do?City="+City);
//}