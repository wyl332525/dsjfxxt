...
function getStationInfo() {
	//获取检测车辆次数
	var args1 = {
			sqlKey : "com.kmzc.dao.dsj.Survey.SurveyAll",
			strattime : startdate,
			endtime : enddate
		}
...
//	window.top.$("#checkQualifieCityWinIframe").attr("src", rootPath + "/common/jxh/checkSurveyCityList.yt?City="+City);
//	checkQualifieCityWin.window('open');
	parent.popWindow.init(1600, 650, rootPath + "/view/mainpage/checkSurveyCityList.do?City="+City);
}
