...
function hkwsspcj(id){
    ...
    var m_utilsInc = new Utils();  //工具模块实例
...
function HttpPluginClient(){
    ...
    //http请求列表，静态成员
    this.m_httpRequestSet = [];
    
    //设置这次请求的参数
    this.setRequestParam = function (options) {
    ...
    this.getHttpMethod = function (szMethod) {
	...
	this.processCallback = function (iRequstID, szHttpContent) {
	...
	this.httpDataAnalyse = function (oHttpRequest, szHttpContent) {
	    //数据分析，后续要提出这个部分
...
function ISAPIProtocol(){
	...
	this.login = function (szIP, iPort, szAuth, options) {
        //组成url
    ...
    this.getAudioInfo = function (deviceInfo, options) {
        //组成url
    ...
    this.getDeviceInfo = function (deviceInfo, options) {
        //组成url
    ...
    this.getAnalogChannelInfo = function (deviceInfo, options) {
        //组成url
    ...
    this.getDigitalChannel = function (deviceInfo, options) {
		//组成url
    ...
    this.getDigitalChannelInfo = function (deviceInfo, options) {
    ...
    this.getZeroChannelInfo = function (deviceInfo, options) {
        //组成url
    ...
    this.getStreamChannels = function (deviceInfo, options) {
    ...
    this.getPPPoEStatus = function (deviceInfo, options) {
        //组成url
    ...
    this.getUPnPPortStatus = function (deviceInfo, options) {
        //组成url
    ...
    this.getNetworkBond = function (deviceInfo, options) {
        //组成url
    ...
    this.getNetworkInterface = function (deviceInfo, options) {
        //组成url
    ...
    this.getPortInfo = function (deviceInfo, options) {
        //组成url
    ...
    this.startRealPlay = function (oDeviceInfo, options) {
    ...
    this.startVoiceTalk = function (oDeviceInfo, iAudioChannel) {
        //组成url
    ...
    this.ptzAutoControl = function (oDeviceInfo, bStop, oWndInfo, options) {
    ...
    this.ptzControl = function (oDeviceInfo, bStop, oWndInfo, options) {
        var iChannelID = oWndInfo.iChannelID,
            szUrl = "";
    ...
    this.setPreset = function (oDeviceInfo, oWndInfo, options) {
        var iChannelID = oWndInfo.iChannelID,
            szUrl = "",
            szData = "";
    ...
    this.goPreset = function (oDeviceInfo, oWndInfo, options) {
        var iChannelID = oWndInfo.iChannelID,
            szUrl = "";
    ...
    this.recordSearch = function (oDeviceInfo, options) {
        var szUrl = "",
            szData = "",
        ...
        szData = "<?xml version='1.0' encoding='UTF-8'?>" +
            "<CMSearchDescription>" +
            "<searchID>" + new UUID().createUUID() + "</searchID>" +
    ...
    this.startPlayback = function (oDeviceInfo, options) {
    ...
    this.reversePlayback = function (oDeviceInfo, options) {
        var iWndIndex = options.iWndIndex,
            szStartTime = options.szStartTime,
            szEndTime = options.szEndTime;
    ...
    this.startDownloadRecord = function (oDeviceInfo, options) {
        //组成url
    ...
    this.exportDeviceConfig = function (oDeviceInfo) {
        //组成url
    ...
    this.importDeviceConfig = function (oDeviceInfo, options) {
        //组成url
        var szUrl = _FormatString(this.CGI.deviceConfig, oDeviceInfo.szHttpProtocol, oDeviceInfo.szIP, oDeviceInfo.iCGIPort);
    ...
    this.restart = function (oDeviceInfo, options) {
        //组成url
    ...
    this.restore = function (oDeviceInfo, szMode, options) {
        //组成url
    ...
    this.startUpgrade = function (oDeviceInfo, options) {
        //组成url
    ...
    this.set3DZoom = function (oDeviceInfo, oWndInfo, szZoomInfo, options) {
        var iChannelID = oWndInfo.iChannelID,
            szUrl = "";
    ...
    this.getSDKCapa = function (deviceInfo, options) {
        //组成url
...
function PSIAProtocol() {
    ...
    this.getStreamDynChannels = function (deviceInfo, options) {
        //组成url
...
function Utils(){
	...
	this.toXMLStr = function (oXmlDoc) {
	    var szXmlDoc = "";
	...
	this.escape = function (szStr) {
	    return szStr.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;");
	};
	
	this.dateFormat = function (oDate, fmt) {
	    var o = {
...
function UUID() {
    ...
    this.createUUID = function () {
        ...
        var csar = UUID.getIntegerBits(this.rand(4095), 0, 7);
        var csl = UUID.getIntegerBits(this.rand(4095), 0, 7);

        var n = UUID.getIntegerBits(this.rand(8191), 0, 7) +
            UUID.getIntegerBits(this.rand(8191), 8, 15) +
            UUID.getIntegerBits(this.rand(8191), 0, 7) +
            UUID.getIntegerBits(this.rand(8191), 8, 15) +
            UUID.getIntegerBits(this.rand(8191), 0, 15); // this last number is two octets long
