...
<head>
	...
	<link href="<%=rootPath %>/css/BigData.css" rel="stylesheet" type="text/css">
	<link href="<%=rootPath %>/css/index.css" rel="stylesheet" type="text/css">
	<link href="<%=rootPath %>/css/index01.css" rel="stylesheet" type="text/css">
	<link href="<%=rootPath %>/css/Security_operation.css" rel="stylesheet" type="text/css">
    <link href="<%=rootPath %>/js/bstable/css/bootstrap.min.css" rel="stylesheet" type="text/css" />
    <link href="<%=rootPath %>/js/bstable/css/bootstrap-table.css" rel="stylesheet" type="text/css" />
...
<script src="<%=rootPath %>/js/echarts-all.js"></script>
...
<script src="<%=rootPath %>/js/Home_page.js"></script>
<script src="<%=rootPath %>/js/artDialog/artDialog.js"></script>
<script src="<%=rootPath %>/js/artDialog/plugins/iframeTools.source.js"></script>
<script>
    var number;
    $(function() {
