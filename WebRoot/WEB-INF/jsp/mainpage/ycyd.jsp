...
<script src="<%=rootPath%>/js/jxh/ycyd.js" type="text/javascript"></script>
<%
...
<body style="overflow: hidden;">
	<div style="margin-top:20px;float:left;">
		...
		<label class="label-btn" onclick="getycyd()">查询</label>
	</div>
	<br /><br />
	<div id="dataTable" style="height:550px;width:100%;margin-top:20px;">
