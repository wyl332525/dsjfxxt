...
<html>
	<head>
		...
		<script src="<%=rootPath %>/js/jxh/hbcyjctj.js" type="text/javascript"></script>
	</head>
	<body style="overflow: hidden;">
	<div style="text-align:center;font-size:30px;font-weight:bold;margin-top:15px;">版纳州柴油车检测散布图</div>
