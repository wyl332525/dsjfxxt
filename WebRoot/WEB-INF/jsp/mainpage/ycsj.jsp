...
<script src="<%=rootPath%>/js/jxh/ycsj.js" type="text/javascript"></script>
<%
...
<body style="overflow: hidden;">
	<div style="margin-top:20px;float:left;">
		...
		<label class="label-btn" onclick="getycsj()">查询</label>
	</div>
	<br /><br />
	<div id="dataTable1" style="height:550px;width:100%;margin-top:20px;">
			<table id='gridTable1' class="easyui-datagrid" style="height:100%;"></table>
		</div>
</body>
</html>
