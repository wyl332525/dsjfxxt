...
<html>
	<head>
		...
		<script src="<%=rootPath %>/js/jxh/dshgltj.js" type="text/javascript"></script>
	</head>
	
	
<body style="overflow: hidden;">
	<div style="text-align:center;font-size:30px;font-weight:bold;margin-top:15px;">各站点按检测方法统计合格率折线图</div>
